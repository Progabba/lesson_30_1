...
class LessonCRUDTests(APITestCase):
    def setUp(self):
        ...
        self.moderator = User.objects.create_user(
            email="moderator@test.com", password="password", is_moderator=True
        )
        self.user = User.objects.create_user(email="user@test.com", password="password")

        # Создаем тестовый курс
        self.course = Course.objects.create(
            title="Test Course", description="Description", user=self.moderator
        )
...
class CourseSubscriptionTests(APITestCase):
    def setUp(self):
        ...
        # Создаем тестовый курс
        self.course = Course.objects.create(
            title="Test Course", description="Description", user=self.user
        )
